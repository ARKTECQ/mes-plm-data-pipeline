...
RAW_DIR = PROJECT_ROOT / "data" / "raw" / "plm"
...
# Run PLM Ingestion
def run_plm_ingestion():

    logging.info("========== PLM Ingestion Started ==========")

    for filename in EXPECTED_SCHEMAS:
        ingest_file(filename)

    logging.info("========== PLM Ingestion Completed ==========")
